<template>
  <div>
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt class="govuk-summary-list__key widerColumn">
          Have you ever been convicted of a criminal offence? This includes spent convictions, even if they are protected.
        </dt>
        <dd
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt class="govuk-summary-list__key widerColumn">
          Have you ever been cautioned for a criminal offence? This includes cautions that are spent, even if they are protected.
        </dt>
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you received a fixed penalty notice in the last 4 years?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Were you convicted of any motoring offences in the past 4 years?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever entered into an Individual Voluntary Agreement (IVA) or other similar arrangement?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever filed late tax returns and/or made late tax payments?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever filed late VAT returns and/or made late VAT payments?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever been fined by HMRC?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Are you aware of any open HMRC enquiries into your tax affairs?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever been, or are you currently, the subject of a complaint or an allegation of professional misconduct? You do not need to declare any complaint that was dismissed in full.
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever been, or are you currently, the subject of an allegation or claim of professional negligence? You do not need to declare any claim that was dismissed or withdrawn without a settlement.
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever been, or are you currently, subject of an allegation or claim of wrongful dismissal?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever been, or are you currently, subject of an allegation or claim of discrimination proceedings?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever been, or are you currently, subject of an allegation or claim of harassment proceedings?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever been, or are you currently, subject of complaints or disciplinary action?
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
    ...
    <dl class="govuk-summary-list govuk-!-margin-bottom-0">
      <div class="govuk-summary-list__row">
        <dt :class="requiredStyle">
          Have you ever been, or are you currently, the subject of any civil proceedings that you have not already mentioned above? You do not need to declare any proceedings that were dismissed or withdrawn without a settlement.
        </dt>
        <dd
          class="govuk-summary-list__value"
        >
  ...
  computed: {
    signedDeclaration() {
      if (this.formData.declaration1 === true &&
        ...
        this.formData.declaration4 === true) {
        return true;
      }
      return false;
    },
