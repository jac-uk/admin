<template>
  ...
  >
    ...
    <!-- Modal @TODO: RENAME! -->
    <UserFeedbackModal v-if="isSignedIn" />
...
export default {
  ...
  mounted() {
    this.buttonElement = document.querySelector('.user-feedback-link');
